      ...
      <div className="mx-auto flex min-h-screen max-w-7xl flex-col px-4 py-6 sm:px-6 lg:px-8">
        ...
        <main className="flex-1">
          <div className="mb-4 flex w-full gap-2 rounded-2xl bg-neutral-200/70 p-1 sm:w-fit">
            <button className="rounded-2xl bg-white px-4 py-2 text-sm font-medium shadow-sm">
              다리미 모드
            </button>
            <button className="rounded-2xl px-4 py-2 text-sm font-medium text-neutral-500">
              감정 쓰레기통
            </button>
          </div>
